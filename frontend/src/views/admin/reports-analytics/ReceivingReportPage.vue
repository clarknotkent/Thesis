      ...
      <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
          <h1 class="h3 mb-0 text-gray-800">
            {{ isNew ? 'New Receiving Report' : `Receiving Report ${form.report_number || ''}` }}
          </h1>
          ...
          <div>
            ...
            <div class="table-responsive">
              <table class="table table-sm align-middle table-striped">
                <thead>
                  <tr>
                    <th style="min-width: 160px;">Vaccine (existing)</th>
                    <th style="min-width: 120px;">Antigen</th>
                    ...
                    <th style="min-width: 220px;">Qty</th>
                ...
                <tbody>
                  <tr v-for="(it, idx) in visibleItems" :key="it.item_id || idx">
                    <td>
                      <select class="form-select form-select-sm" v-model="it.vaccine_id" @change="onSelectVaccine(it)" :disabled="isCompleted">
