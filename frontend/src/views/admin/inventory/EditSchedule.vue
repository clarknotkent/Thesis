<template>
  <AdminLayout>
    <div class="container-fluid">
      ...
      <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
          <h1 class="h3 mb-0 text-gray-800">
            <i class="bi bi-pencil me-2"></i>Edit Vaccine Schedule
          </h1>
          <p class="text-muted mb-0">Modify vaccination schedule and dosage timeline</p>
        </div>
      ...
      <!-- Form Card -->
      <div v-else-if="scheduleLoaded" class="card shadow">
