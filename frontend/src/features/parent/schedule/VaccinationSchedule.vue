    ...
    <div class="vaccination-schedule">
          ...
          <div class="d-flex align-items-center">
            ...
            <div class="flex-grow-1">
              ...
              <p class="text-muted mb-2">
                {{ childInfo.ageDisplay }} • {{ childInfo.gender }}
              </p>
        ...
        <div class="timeline-container">
          ...
          >
            <div class="timeline-marker">
              <i :class="getVaccineIcon(vaccine.status)" />
            </div>
                ...
                <div class="d-flex align-items-start">
                  ...
                  <div class="flex-grow-1">
                    ...
                    <div class="vaccine-details">
                      ...
                      <div
                        v-else-if="vaccine.status === 'upcoming'"
                        class="upcoming-info"
                      >
                      ...
                      <div
                        v-else-if="vaccine.status === 'overdue'"
                        class="overdue-info"
                      >
                        <div class="d-flex align-items-center justify-content-between">
                          <div>
          ...
          <div class="row g-3">
            <div class="col-md-6">
              <div class="resource-item">
                <i class="bi bi-shield-check text-info fs-3 mb-2" />
                <h6>Why Vaccinate?</h6>
                <p class="small text-muted">
                  Learn about the importance of vaccines in protecting your child from serious diseases.
                </p>
                <AppButton
                  variant="outline-info"
                  size="sm"
                  @click="learnMore('importance')"
                >
                  Learn More
                </AppButton>
              </div>
            ...
            <div class="col-md-6">
              <div class="resource-item">
                <i class="bi bi-question-circle text-success fs-3 mb-2" />
                <h6>Common Questions</h6>
                <p class="small text-muted">
                  Find answers to frequently asked questions about vaccinations.
                </p>
                <AppButton
      ...
      <div class="emergency-contact">
        <AppCard class="parent-emergency-card text-center">
          <i class="bi bi-question-circle-fill fs-3 mb-2 text-warning" />
          <h6 class="mb-2">
            Have Questions About Vaccinations?
          </h6>
          <p class="mb-3">
            Contact our health center for guidance and support
          </p>
