<template>
  ...
  >
    <div class="card-body">
      ...
      <div class="row g-2 mb-3">
        <div class="col-md-4">
          ...
          <div class="text-muted">
            {{ formatDate(visit.created_at || visit.visit_date) }}
          </div>
        </div>
        <div class="col-md-4">
        ...
        <div class="col-md-4">
          ...
          <div class="text-muted">
            {{ visit.service_rendered || visit.visit_type || '—' }}
          </div>
        </div>
      </div>
      ...
      <!-- Vital Signs Section -->
      <div class="mb-3">
        <h6><i class="bi bi-heart-pulse me-2" />Vital Signs</h6>
        <div
          v-if="hasVitalSigns(visit)"
          ...
          <table class="table table-sm table-bordered">
            <tbody>
              ...
              <tr v-if="getVitalSign(visit, 'pulse') || getVitalSign(visit, 'heart_rate')">
                <td class="fw-semibold">
                  <i class="bi bi-heart me-2" />Pulse/Heart Rate
                </td>
      ...
      <div class="mb-3">
        <h6><i class="bi bi-shield-check me-2" />Services / Immunizations Given</h6>
        <div v-if="(visit.immunizations_given && visit.immunizations_given.length) || (visit.immunizations && visit.immunizations.length)">
          <ul>
            <li
              v-for="im in (visit.immunizations_given || visit.immunizations || [])"
              :key="im.immunization_id || im.vaccine_id"
            >
        ...
        <div
          ...
          class="text-muted small"
        >
          No immunizations or services recorded for this visit.
        </div>
      </div>

      <!-- Findings Section -->
      <div class="mb-3">
        <h6><i class="bi bi-clipboard-data me-2" />Findings / Remarks</h6>
