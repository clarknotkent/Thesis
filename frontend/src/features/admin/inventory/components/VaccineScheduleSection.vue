<template>
  <div class="vaccine-schedule-section">
    ...
    <div v-else-if="schedules.length === 0" class="text-center py-5">
      ...
      <p class="text-muted mt-3">No vaccine schedules found</p>
      <router-link to="/admin/vaccines/schedules/add" class="btn btn-primary">
      ...
      <table class="table table-hover table-bordered">
        <thead class="table-light">
          <tr>
            ...
            <th class="text-center">Total Doses</th>
