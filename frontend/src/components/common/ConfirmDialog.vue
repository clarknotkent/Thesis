<template>
  <div v-if="show" class="modal fade show" style="display: block;" tabindex="-1" @click.self="cancel">
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header" :class="`bg-${variant} bg-opacity-10`">
        ...
        <div class="modal-footer">
          ...
          <button type="button" :class="`btn btn-${variant}`" @click="confirm">{{ confirmText }}</button>
        </div>
      </div>
    </div>
  </div>
