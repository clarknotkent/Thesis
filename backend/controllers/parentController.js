...
import { verifyPassword, changePassword } from '../models/authModel.js';
...
const getParentProfile = async (req, res) => {
  try {
    ...
    // Get children count
    const { count: childrenCount, error: _countError } = await supabase
      .from('patients')
...
const getRecommendedAge = (doseNumber, _category) => {
