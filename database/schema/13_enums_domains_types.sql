...
| composite | public | guardian_auto_send_settings   | is_deleted                           | boolean                     |
| composite | public | guardian_auto_send_settings   | updated_at                           | timestamp without time zone |
| composite | public | guardian_auto_send_settings   | updated_by                           | integer                     |
...
| composite | public | immunizationhistory_view      | patient_guardian_full_name           | text                        |
...
| composite | public | immunizationhistory_view      | patient_tag                          | character varying(20)       |
...
| composite | public | sms_logs                      | id                                   | integer                     |
| composite | public | sms_logs                      | is_deleted                           | boolean                     |
...
| composite | public | sms_logs                      | type                                 | character varying(20)       |
| composite | public | sms_logs                      | updated_at                           | timestamp without time zone |
...
| composite | public | sms_templates                 | is_deleted                           | boolean                     |
| composite | public | sms_templates                 | name                                 | character varying(100)      |
| composite | public | sms_templates                 | template                             | text                        |
| composite | public | sms_templates                 | time_range                           | character varying(50)       |
| composite | public | sms_templates                 | trigger_type                         | character varying(20)       |
| composite | public | sms_templates                 | updated_at                           | timestamp without time zone |
| composite | public | sms_templates                 | updated_by                           | integer                     |
