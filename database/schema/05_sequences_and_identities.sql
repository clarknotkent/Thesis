...
LEFT JOIN (
  ...
  WHERE att.attnum > 0 AND NOT att.attisdropped
    ...
    AND pn.nspname = 'public' -- Limit to public schema only
)
...
| public | guardian_auto_send_settings_id_seq                       | 1        | 1      | 2147483647          | 1            | 1        | false    | public       | guardian_auto_send_settings   | id                          |
...
| public | sms_logs_id_seq                                          | 1        | 1      | 2147483647          | 1            | 1        | false    | public       | sms_logs                      | id                          |
| public | sms_templates_id_seq                                     | 1        | 1      | 2147483647          | 1            | 1        | false    | public       | sms_templates                 | id                          |
